...
var QueueAnim = function (_React$Component) {
  ...
  QueueAnim.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    if (this.state.children.length) {
       ...
       * 所以这里需要处理出场完成的元素做清除。
       */
      var stateChildrens = (0, _utils.mergeChildren)(currentChildren, this.state.children);
      var currentChild = [];
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getChildrenToRender = function (child) {
    ...
    var tag = (0, _react.createElement)(_rcTweenOne2['default'], { key: key, component: child.type, forcedJudg: forcedJudg, componentProps: child.props, animation: animation });
